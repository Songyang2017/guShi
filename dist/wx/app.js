...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$db = wx.cloud.database();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_2_0_1_mpvue_loader_lib_selector_type_script_index_0_App_vue__ = __webpack_require__(21);
var disposed = false
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54bede0f", Component.options)
  } else {
    hotAPI.reload("data-v-54bede0f", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  mutations: {
    changeOrg: function changeOrg(state, payload) {
      state.origin = payload;
    },
    getUserInfo: function getUserInfo(state, payload) {
      state.userInfo = payload;
    },
    getTipCollect: function getTipCollect(state) {
